...
public final class KeyboardUtils {
    ...
    private static int getContentViewInvisibleHeight(final Window window) {
        ...
        Logger.d("KeyboardUtils" + "getContentViewInvisibleHeight: "
    ...
    public static void clickBlankArea2HideSoftInput() {
        Logger.i("KeyboardUtils", "Please refer to the following code.");
        /*
        @Override
    ...
    /**
     * 延迟显示软键盘(延迟是为了解决当前view所在布局页面还未显示出来时，无法显示软键盘的问题)
     *
     * @param et
     * @param delayMillis
     */
    public static void openKeybord(EditText et, long delayMillis) {
        et.postDelayed(() -> openKeybord(et, et.getContext()), delayMillis);
    }
     ...
     * @param edit 输入框
     */
    public static void closeSoftInput(EditText edit) {
        edit.clearFocus();
        InputMethodManager inputmanger = (InputMethodManager) edit.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        inputmanger.hideSoftInputFromWindow(edit.getWindowToken(), 0);
    }
